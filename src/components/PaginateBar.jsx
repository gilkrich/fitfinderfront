        ...
        <div className="pagination-container">
            <div className="pagination">
                ...
                {pageNumbers.map((number, index) => (
                    <button key={index} style={{backgroundColor:currentpage==number?"rgb(87, 56, 175)":'white',Color:currentpage==number?"white":'black'}} className="page-number" onClick={() => {setcurrentpage(number),window.scroll({top: 0,left: 0,behavior: 'smooth'})}} >
                        {number}
                    </button>
                ))}
