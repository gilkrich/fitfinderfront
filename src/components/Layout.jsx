    ...
    <>
      <nav className="top-nav">
        ...
        {userinfo && <div className="middle-nav">
          ...
          <Link className="layout-link" to={"/bodytypesgraph"}><div className="logo">Stylist</div></Link>
